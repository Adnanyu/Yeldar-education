    ...
    return (
        <div className="space-y- container mx-auto mb-10 p-4 6xl:!container lg:max-w-[85vw] bg-gray-100">
            ...
            <div className="mt-3 flex items-center justify-center text-center">
                <h1 className="text-lg font-bold mb-6 md:text-2xl text-[#242D4B]">{t('contact.title')}</h1>
            </div>
            <div className="space-y-4"><div className="grid w-full grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2">
                <div>
                    <p className="text-black">
                        <span className="text-[#242D4B] font-bold">{t('contact.email')} </span><a href="mailto:yeldareducation@gmail.com">yeldareducation@gmail.com</a>.
                    </p>
                    <p className="text-black">
                        <span className="text-[#242D4B] font-bold">{t('contact.whatsapp')} </span> <a className=" text-[#4fce5d]" href="https://api.whatsapp.com/send?phone=905345155355" aria-label="whatsapp" target="_blank">{t('contact.clickHere')} </a>
                    </p>
                </div>
                <div>
                    <h1 className="text-lg font-bold mb-6 md:text-2xl text-[#242D4B]">{t('contact.visitUs')}</h1>
